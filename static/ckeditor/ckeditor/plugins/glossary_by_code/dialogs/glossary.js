...
CKEDITOR.dialog.add( 'glossaryDialog', function( editor ) {
    return {
        ...
        contents: [
            {
                ...
                elements: [
                    ...
                    },
                    {
                        ...
                        id: 'code',
                        label: 'Code',
                        requiredContent: 'glossary[code]',
                        validate: CKEDITOR.dialog.validate.notEmpty( "Code field cannot be empty." ),
                        ...
                        commit: function( element ) {
                            element.setAttribute( "code", this.getValue() );
                        }
                    }
                ]
            }
        ...
        onShow: function() {
            ...
            if ( !this.insertMode ) {
                this.setupContent( this.element.getText(), this.element.getAttribute( "code" ) );
            } else {
